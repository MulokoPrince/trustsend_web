  ...
  return (
    <section className="px-6">
      <Reveal className="mx-auto max-w-6xl">
        <div className="relative overflow-hidden rounded-4xl sm:rounded-5xl bg-brand px-6 py-12 sm:px-8 sm:py-16 lg:py-20 text-center">
          ...
          <h2 className="relative font-display font-bold text-2xl sm:text-3xl lg:text-4xl text-white max-w-2xl mx-auto">
            {t("ctaBanner.title")}
          </h2>
          <p className="relative mt-4 text-white/80 text-base sm:text-lg max-w-2xl mx-auto">
